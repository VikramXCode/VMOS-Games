  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        neon:
          "bg-gradient-to-r from-primary to-secondary text-primary-foreground font-semibold hover:shadow-[0_0_25px_hsl(var(--primary)/0.6)] hover:scale-[1.02]",
        success:
          "bg-accent text-accent-foreground hover:bg-accent/90 hover:shadow-[0_0_20px_hsl(var(--accent)/0.5)]",
        whatsapp:
          "bg-[hsl(142_70%_45%)] text-white hover:bg-[hsl(142_70%_40%)] hover:shadow-[0_0_20px_hsl(142_70%_45%/0.5)]",
        call:
          "bg-neon-orange text-primary-foreground hover:bg-neon-orange/90 hover:shadow-[0_0_20px_hsl(var(--neon-orange)/0.5)]",
      },
      size: {
